 ...
 * Created by yaonengjun on 2018/1/24 下午5:45.
 */
...
public class SSH2Util {
  ...
  public static void main(String[] args) throws Exception {
    SSH2Util ssh2Util = new SSH2Util("74.207.254.19", "root","gggg963963", 22);
    String result =  ssh2Util.runCommand("cd /opt && ls -lh");
    System.out.println("");
    System.out.println("--------");
...
//    ssh2Util.putFile("/temp", "aa.jpg", "/opt/temp");
    ssh2Util.close();
  }
}